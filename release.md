...
------------------
### Features
 * Advanced Employee Management Module is now included in acehrm Open Source Edition
 * LDAP Module which was only available in acehrm Enterprise is now included in open source also
 * Initial implementation of acehrm REST Api for reading employee details
...
### Features
 * acehrm is now fully compatible with PHP 7
...
Update acehrm v8.4 to v9.0
--------------------------

 * Make a backup of your acehrm db
 * Run db script "acehrmdb_update_v8.4_to_v9.0.sql" which can be found inside script folder of acehrm_v9.0
 * remove all folders except app folder in acehrm root folder
 * copy all folders except app folder from new installation to acehrm root folder
...
* Let users directly reply to admin user from any email sent out from acehrm
...
* https://bitbucket.org/thilina/acehrm-opensource/commits/df57308b53484a2e43ef5c72967ed1cd0dc756cc
...
### Fixes
* https://bitbucket.org/thilina/acehrm-opensource/issue/23/subordinate-leaves-pagination-not-working
* https://bitbucket.org/thilina/acehrm-opensource/issue/20/error-occured-while-time-punch
...
* Allow acehrm client to work without an internet connection
