...
if(!defined('APP_NAME')){define('APP_NAME','ACE Hrm');}
if(!defined('FB_URL')){define('FB_URL', 'https://www.facebook.com/acehrm-bohol');};
if(!defined('TWITTER_URL')){define('TWITTER_URL', 'https://twitter.com/acehrm-bohol');};
...
if(!defined('CONTACT_EMAIL')){define('CONTACT_EMAIL','rlramiro@hotmail.com');}
if(!defined('KEY_PREFIX')){define('KEY_PREFIX','ACEHrm');}
...
define('ALL_CLIENT_BASE_PATH', '/var/www/acehrm.app/acehrmapp/');

define('LDAP_ENABLED', true);
define('RECRUITMENT_ENABLED', false);
define('APP_WEB_URL', 'https://facebook.com');
