		...
		<div class="tab-pane active" id="tabPageUsage">
			<div id="Usage" class="reviewBlock" data-content="List" style="padding-left:5px;">
				<div class="callout callout-info">
					<h3>How Do You Want to Use AceHrm</h3>

					<p style="font-size: 1.2em;">
						In order to make AceHrm user interface much simpler to use for you and your employees you
						can select the purpose of using AceHrm for your company. This will disable unwanted modules
				...
				<div class="row">
					<div class="col-lg-4 col-xs-12">
						<div class="callout callout-gray">
							...
							<p style="font-size: 1.2em;">
								Use all the Available Modules in AceHrm. This option will enable all the modules
						...
						<div class="callout callout-white">
							...
							<p style="font-size: 1.2em;">
								Use AceHrm as a Leave / Vacation Management System, Allow Employees to Apply for leave,
						...
						<div class="callout callout-gray">
							...
							<p style="font-size: 1.2em;">
								Use AceHrm as a Document Management System, Allow Employees upload documents, Automated
					...
					<div class="col-lg-4 col-xs-12">
						<div class="callout callout-white">
							...
							<p style="font-size: 1.2em;"><br/>
								Use AceHrm as an Attendance Management and Time Tracking System. Let employees record
						...
						<div class="callout callout-gray">
							...
							<p style="font-size: 1.2em;">
								Use AceHrm as a Training Management System. Create courses and training sessions. Let
					...
					<div class="col-lg-4 col-xs-12">
						...
						<div class="callout callout-white">
							...
							<p style="font-size: 1.2em;">
								Process your company payroll using AceHrm and Store employee salary
							</p>
						</div>
					</div>
					<?php }?>
