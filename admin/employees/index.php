    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<?=t('Employee needs a User to login to AceHrm. Do you want to create a user for this employee now?')?> <br/><br/><?=t('You can do this later through Users module if required.')?>
            </div>
